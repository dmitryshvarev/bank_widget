import pytest
from src.bank_widget.masks import get_mask_card_number, get_mask_account
...
@pytest.mark.parametrize("card_number, mask_card_number", [("700079226361", "7000 79** 6361"),
...
@pytest.mark.parametrize("user_account, mask_account", [("730135874305", "730135874305"),
